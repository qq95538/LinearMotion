...
int main(int argc, char** argv) {
    ...
    while(true){
    	...
    	recvfrom(socket_descriptor,recv_buf,sizeof(recv_buf),0,(struct sockaddr *)&recv_from_address, &recv_from_addr_length);
    	...
    	case BUF0_COMMAND_SERVER_TO_CLIENT_EXIT_NOTIFICATION:
    		...
    		printf("Program Main Loop Ended.\n");
    		return 0;
    		break;
    	default:
